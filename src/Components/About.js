...
const About = () => {
  return (
    <div className="bg-gray-100 py-8 px-4 md:px-8 lg:px-16">
      ...
      <p className="text-gray-700 mb-4">
        We started our company in 2023 with a simple goal: to connect people with the food they love. We've grown rapidly since then, and now we operate in over 100 cities across India.
      </p>
      <p className="text-gray-700 mb-4">
